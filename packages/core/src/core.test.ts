...
import { commitLadderSlice, failLadderSlice, makeLadder, tickLadders } from "@wick/core/entry";
import { hitExit, isLiveDump, queueChainExits, upsertChainExit } from "@wick/core/exits";
import { blendScore, moodOf, tapeScore, toneOf } from "@wick/core/sentiment";
import { flowBias, followPrints, nameFlowOf } from "@wick/core/smart-flow";
import {
  copySize,
  pickNews,
  styleDelay,
  ...
  styleSkip,
  swapPrint,
} from "@wick/core/live-copy";
import { fraudOf, fraudSkip } from "@wick/core/fraud";
import { liveSnipeOk } from "@wick/core/snipe-live";
import { filterTape, tapeRank } from "@wick/core/tape";
import { riskScore, isRug } from "@wick/core/market";
import { impactPct } from "@wick/core/jup";
