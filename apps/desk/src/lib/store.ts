...
import {
  ...
  isRug,
  mergeLiveToken,
} from "@wick/core/market";
import { clampNum, isB58, isSig, sanitizeLabel } from "@wick/core/guard";
import { RISK_DEFAULTS, shouldHalt, snipeEdge, type RiskLimits } from "@wick/core/risk";
...
import {
  ...
  type ChainExit,
  type ExitBook,
} from "@wick/core/exits";
import { lockHotMem, peekSecret, slimVault, type HotVault } from "@wick/core/hot-wallet";
import {
  bumpConfirm,
  isFollowId,
  pickNews,
...
import type { ChainHolding, ChainPrint } from "@wick/core/solana-wallet";
